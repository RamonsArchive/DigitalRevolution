...
const ProductPageClient = ({ slug }: ProductPageClientProps) => {
  const { allProducts, productDetailsMap } = useShopFilters();
  const {
  ...
  // Get product from context data
  const product = useMemo(() => {
    return getProductBySlug(slug, allProducts);
  }, [slug, allProducts]);
  ...
  // Get detailed product information for current variant
  const productDetails = useMemo(() => {
    return currentVariant
      ? productDetailsMap.get(currentVariant.variant_id)
      : null;
  }, [currentVariant, productDetailsMap]);
      ...
      <div className="flex flex-col lg:flex-row gap-10 w-full">
        ...
        <div className="flex flex-col gap-6 w-full lg:w-[40%]">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl lg:text-4xl font-bold text-white font-courier-prime">
          ...
          <div className="space-y-4">
            ...
            {availableSizes.length > 1 && (
              <div>
                <h3 className="text-sm font-medium text-gray-100 mb-2">Size</h3>
                <div className="flex gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center border border-gray-300 rounded-lg">
              <button
                ...
                className="px-3 py-2 hover:bg-gray-300 transition-colors duration-200 rounded-l-lg"
              >
                -
              </button>
              ...
              <button
                ...
                className="px-3 py-2 hover:bg-gray-300 transition-colors duration-200 rounded-r-lg"
              >
                +
              </button>
            </div>
            ...
            <div className="space-y-2 text-sm text-gray-200">
              {currentVariant && (
                <>
                  ...
                  <p>
                    ...
                    <span
                      className={`capitalize ${
                        currentVariant.availability_status === "active"
                          ? "text-green-400"
                          : "text-red-400"
                      }`}
                    >
                  ...
                  {/* Detailed product information from Printful Catalog */}
                  {productDetails && (
                    <>
                      ...
                      {productDetails.dimensions &&
                        Object.keys(productDetails.dimensions).length > 0 && (
                          <div>
                            ...
                            <span className="text-gray-100">
                              {Object.entries(productDetails.dimensions)
                  ...
                  {/* Fallback for when detailed info is not yet loaded */}
                  {!productDetails && (
