    ...
    <div className="min-h-screen flex flex-col bg-bg-primary gap-16 pb-20">
      ...
      <div className="flex flex-col gap-[4.5rem] md:gap-20 bg-linear-to-b from-bg-primary via-slate-900/50 to-bg-primary h-full">
        ...
        <section className="px-6 md:px-12 py-10 md:py-12">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-[3.5rem] md:mb-16">
              <h3 className="flex flex-col gap-2 items-center justify-center text-4xl md:text-5xl font-extrabold bg-linear-to-r from-primary-200 to-secondary-200 bg-clip-text text-transparent mb-4">
                Partnership Gallery{" "}
