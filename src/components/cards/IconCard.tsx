    ...
    <div className={`group relative h-full flex flex-col ${className}`}>
      ...
      >
        ...
        <div className="relative flex items-start gap-6 flex-grow">
          <div
            className={`w-12 h-12 bg-linear-to-r from-primary-500 to-secondary-500 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition duration-300 ${iconClassName}`}
          >
